...
const Hero = () => {
  return (
   <div id="home" className="w-full h-[80vh] scroll-mt-20 bg-[#1f242c] flex flex-col justify-center">
    ...
    {/*Description */}
       <p  data-aos="fade-up"   className='max-w-150 ml-0 md:ml-12 md:mt-10 mt-5 text-sm md:text-base font-semibold'>
        ...
        <button data-aos="fade-up" className="bg-[#1f242c] px-8 py-3 rounded-full mt-10 ml-0 md:ml-12 text-white font-semibold cursor-pointer hover:bg-[#9f7c2d] transition-all duration-300 outline-2 outline-gray-300 w-fit">
  Discover More
</button> </div>
